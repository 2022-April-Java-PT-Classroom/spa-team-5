...
const BioScreen = () => {
    ...
    <div className={style.BioScreen} >
            ...
            href="https://github.com/ackley787">GitHub</a>

            <a className={style.icon} 
            href="https://ackley787.github.io/">Portfolio</a>
            ...
            {/* <a className={style.icon}  
            href="https://github.com/samleivadev">GitHub</a>

            <a className={style.icon}
            href="https://samleivadev.github.io/profile/">Portfolio</a>

            <a className={style.icon} 
            href="https://www.linkedin.com/in/samuelleiva/">Linkedin</a> */}
            ...
            <img className={style.card} src={Joe} alt='3rd profile pic' />
             ...
             {/* <a className={style.icon}  
            href="https://github.com/joebuck125">GitHub</a>

            <a className={style.icon}
            href="https://joebuck125.github.io/">Portfolio</a>

            <a className={style.icon} 
            href="https://www.linkedin.com/in/joe-buckley-4358561a2/">Linkedin</a> */}
            ...
            {/* <a className={style.icon} 
            href="https://www.linkedin.com/in/serena-ann-howard">"Linkedin"</a>
             */}
            
            <p className={style.blurb}>
                
            Highly skilled and experienced Customer Service/Support Specialist
            with a demonstrated track record of success in the financial services
            and auto insurance industries. Key strengths include Communication, 
            Training, English, and Problem Solving. 

            Currently attending We Can Code IT to become a full-stack Java developer 
            to utilize my passion for development, desire to take on challenges, and 
            ...
            {/* <a className={style.icon} 
            href="https://github.com/cmsrimsson">GitHub</a>

            <a className={style.icon} 
            href="https://cmsrimsson.github.io/">Portfolio</a>

            <a className={style.icon}
            href="https://www.linkedin.com/in/chuda-rimal-318b33201/">Linkedin</a> */}
